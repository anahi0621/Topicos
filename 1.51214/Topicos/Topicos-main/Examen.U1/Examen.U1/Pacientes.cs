    ...
    public partial class frmPacientes : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            if (entradaDatos[0] == 1 && entradaDatos[1] == 1 && entradaDatos[2] == 1 && entradaDatos[3] == 1)
            {
                ...
                MessageBox.Show("Registro insertado correctamente en la tabla.", 
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                int rowIndex = dtgvRegistros.CurrentCell.RowIndex;
                dtgvRegistros.Rows.RemoveAt(rowIndex);

                MessageBox.Show("Registro " + (rowIndex + 1) + " eliminado correctamente en la tabla.",
